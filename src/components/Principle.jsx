...
export default function Principle() {
  const principles = [
    {
      id: "01",
      title: "Customer-Centric",
      desc: "Every solution begins with your goals. Your success defines ours."
    },
    {
      id: "02",
      title: "Reliability",
      desc: "Commit to what we can deliver — then deliver precisely, every time."
    },
    {
      id: "03",
      title: "Collaboration",
      desc: "Work side-by-side to build trust, transparency, and shared success."
    },
    {
      id: "04",
      title: "Excellence",
      desc: "Pursue the highest standards in every project and every outcome."
    },
    {
      id: "05",
      title: "Respect & Professionalism",
      desc: "Uphold respect and integrity with our team and partners."
    },
    {
      id: "06",
      title: "Continuous Learning",
      desc: "Improve constantly to stay ahead in technology and innovation."
    }
  ];
  ...
  return (
    <section className="relative py-10 px-6 bg-black overflow-hidden">
      ...
      <div className="absolute -top-10 left-0 w-[500px] h-[500px] bg-blue-600/20 blur-[180px]"></div>
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-blue-500/10 blur-[150px]"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          {principles.map((item) => (
            ...
            >
              ...
              <div className="absolute -top-6 -left-6 w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 shadow-2xl flex items-center justify-center">
                <span className="text-white text-3xl font-extrabold tracking-widest"  style={{ fontFamily: "DoppioOne, sans-serif" }}>
                  {item.id}
                </span>
              </div>
